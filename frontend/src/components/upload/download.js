                ...
                <View style={styles.subContainer}>
                    <View style={styles.ThanksContainer}>
                        <Text style={styles.Info1}>
                            Thank you for using our noise removal application! We appreciate your trust in our service.
                            Your video has been processed successfully, and it's now ready for download.
                        </Text>
                        <Text style={styles.Info2}>
                            Download your enhanced video now and experience the improved audio quality.
                        </Text>
                    </View>
