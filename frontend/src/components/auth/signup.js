    ...
    return (
        <>
            <View style={styles.InputContainer}>
                ...
                <View style={styles.InputSubContainer}>
                    <View style={styles.IconView}>
                        <Feather name="lock" size={24} color={Colors.typoWhite} />
                    </View>
                    <TextInput
                        style={[styles.input, { outlineWidth: 0, borderWidth: 0 }]}
            ...
            <View style={styles.TxtView}>
                <Text style={styles.NoAccountTxt}>Already have an account?
                    <TouchableOpacity
                        activeOpacity={0.6}
                        onPress={() => {
                            setLogin(true);
                        }}>
                        <Text style={{ color: Colors.primary60, fontWeight: '700', fontSize: 16 }}> Log In</Text>
                    </TouchableOpacity>
                </Text>
            </View>
        </>
